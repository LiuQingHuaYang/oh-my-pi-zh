...
export const TUI_KEYBINDINGS = {
	...
	"tui.editor.pageUp": { defaultKeys: "pageUp", description: "上翻页" },
	"tui.editor.pageDown": { defaultKeys: "pageDown", description: "下翻页" },
	...
	"tui.editor.yankPop": { defaultKeys: "alt+y", description: "循环粘贴" },
	...
	"tui.select.up": { defaultKeys: "up", description: "上移选择" },
	"tui.select.down": { defaultKeys: "down", description: "下移选择" },
	"tui.select.pageUp": { defaultKeys: "pageUp", description: "选择区上翻页" },
	"tui.select.pageDown": {
